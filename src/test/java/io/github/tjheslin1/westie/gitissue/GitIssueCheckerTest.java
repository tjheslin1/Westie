...
public class GitIssueCheckerTest implements WithAssertions, WithMockito {
    ...
    public void checksGitIssueIsInOpenState() throws Exception {
        ...
        lineMatchAssertions.violationsContainLineMatching("'//TODO Git-100 make this final' in file '.*/io/github/tjheslin1/examples/git/ClassWithGitIssueTodo.java.*");
        lineMatchAssertions.violationsContainLineMatching("'// TODO Git-101 set passed parameter as name' in file '.*/io/github/tjheslin1/examples/git/ClassWithGitIssueTodo.java.*");
        lineMatchAssertions.violationsContainLineMatching("'//TODO Git-100 make this final' in file '.*/io/github/tjheslin1/examples/git/nested/AnotherClassWithGitIssueTodo.java.*");
        lineMatchAssertions.violationsContainLineMatching("'// TODO Git-101 set passed parameter as name' in file '.*/io/github/tjheslin1/examples/git/nested/AnotherClassWithGitIssueTodo.java.*");
    }
